<html>
<head>
    <title>Developrs</title>
        <!-- Load Roboto font -->
        <link href='http://fonts.googleapis.com/css?family=Roboto:400,300,700&amp;subset=latin,latin-ext' rel='stylesheet' type='text/css'>
        <!-- Load css styles -->
        <link rel="stylesheet" type="text/css" href="css/bootstrap_dev.css" />
        <link rel="stylesheet" type="text/css" href="css/bootstrap-responsive_dev.css" />
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse pull-right">
                        <ul class="nav" id="top-navigation">
                            ...
                            <li class="active"><a href="developers_loggedin.php">Developers</a></li>
                ...
                <div class="row-fluid team">
                    <div class="span4" id="first-person">
                        <div class="thumbnail">
                            ...
                            <div class="mask">
                                <h2>Back-End Designer and Editor</h2>
                            </div>
                        </div>
                    </div>
                    <div class="span4" id="second-person">
                        <div class="thumbnail">
                            ...
                            <div class="mask">
                                <h2>Back-End Designer and Structure Designer</h2>
                            </div>
                        </div>
                    </div>
                    <div class="span4" id="third-person">
                        <div class="thumbnail">
                            ...
                            <div class="mask">
                                <h2>Front-End Designer And Structure Designer</h2>
                            </div>
                        </div>
                    </div>
