<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/style1_downloads.css" />
        <!--[if IE 7]>
                             ...
                             <div id="wrap">
                                <div id="regbar1">
                                  <div id="navthing1">
                                    ...
                                    <div class = "files">
                                    <p><a href="#path_to_file" download="file_name">1) Last Thirty Tollbooth Transactions</a></p>
                                    <p><a href="#path_to_file" download="file_name">2) Rate List Of Tollbooths</a></p>
                                    <p><a href="#path_to_file" download="file_name">3) Last Five Recharge Transactions</a></p>
                                    </div>
                                </div>
                              </div>
